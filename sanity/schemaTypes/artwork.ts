...
export const artwork = defineType({
  ...
  fields: [
    ...
    defineField({ name: "dimensions", title: "Dimensions", type: "string", description: 'Example: "24 x 36 in"' }),
    ...
    defineField({ name: "sortOrder", title: "Sort Order (lower = earlier)", type: "number", initialValue: 100 }),
  ],
});